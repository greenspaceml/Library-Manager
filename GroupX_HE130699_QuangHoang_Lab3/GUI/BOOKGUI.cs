...
namespace GroupX_HE130699_QuangHoang_Lab3.GUI {
    public partial class BookGUI : Form {
        ...
        private void ViewCopies() {
            ...
            int bookNumber = (int)dataGridView1.SelectedRows[0].Cells["bookNumber"].Value;
            txtCopyNumber.Text = bookNumber.ToString();
        ...
        private void displayCopy() {
            txtCopyNumber.Text = c.BookNumber.ToString();
        ...
        private void btnCopyEdit_Click(object sender, EventArgs e) {
            ...
            if (btn.Text == "Edit") {
                ...
                c = new Copy(int.Parse(txtBookNumber.Text), int.Parse(txtCopyNumber.Text), int.Parse(txtSequenceNumber.Text), txtType.Text[0], double.Parse(txtPrice.Text));
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e) {
            ...
            txtCopyNumber.Text = txtBookNumber.Text;
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e) {
            ...
            txtCopyNumber.Text = dataGridView2.Rows[e.RowIndex].Cells["bookNumber"].Value.ToString();
